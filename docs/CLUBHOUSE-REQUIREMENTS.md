...
**PRIV-4 (MUST) — RESOLVED (owner, 2026-08-07):** No one under 18 has ever attended; the club is adult in practice. Owner's call: this is a natural fact, not a message — no 18+ line on the FAQ or other public surfaces. No minor-handling machinery needed in v1; if a minor ever attends, they default to hidden.
...
3. **~~Minors check~~ — RESOLVED:** no minors have ever attended (PRIV-4). Recorded internally; not messaged publicly per owner.
...
*Drafts for PRIV-1, PRIV-2, and PRIV-5. Written to be human and on-brand, not legalese. Not legal advice; a lawyer review before launch is optional but sensible. Minors decision resolved (§19.3): adult club in practice, no public 18+ messaging.*
