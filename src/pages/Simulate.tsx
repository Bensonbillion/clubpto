...
const Simulate = () => {
  ...
  const gameState = useGameState({ simulate: true });

  return (
    <div className="min-h-screen bg-background">
      {/* Simulation banner */}
      <div className="sticky top-0 z-40 bg-amber-600 text-black text-center text-sm font-bold py-2 tracking-wide">
        SIMULATION MODE — No data will be saved
      </div>

      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-8 z-30">
