/**
 * PlayoffBracket for Open Mode — same bracket display, types from openCourtManager.
 * No tier-specific logic in the bracket.
 */
import { PlayoffMatch, Pair } from "@/types/openCourtManager";
...
const BracketMatchCard = ({
  ...
  const court = (match as { court?: number }).court;
